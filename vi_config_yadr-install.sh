...
create_symlinks() {
    ...
    lnif "$endpath/setting/completor.vim"     "$HOME/.vim/settings/completor.vim"
    lnif "$endpath/setting/gtags.vim"         "$HOME/.vim/settings/gtags.vim"
    lnif "$endpath/setting/jedi-vim.vim"      "$HOME/.vim/settings/jedi-vim.vim"
    lnif "$endpath/setting/neosnipeet.vim"    "$HOME/.vim/settings/neosnipeet.vim"
    lnif "$endpath/setting/rainbow.vim"       "$HOME/.vim/settings/rainbow.vim"
    ...
    lnif "$endpath/zsh/autotools.zsh"           "$HOME/.zsh.after/autotools.zsh"
